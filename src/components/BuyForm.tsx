...
const BuyForm = () => {
  ...
  return (
    <div className="relative mx-auto w-full max-w-lg self-stretch rounded-3xl bg-black shadow-xl">
          ...
          <>
            <div className="mb-2 mt-1 w-full">
              <p className="mb-8 text-center text-2xl font-bold text-[#FFD700] drop-shadow-xl">
                Token Buy and Stake <br /> Earn Rewards Daily
              </p>
      ...
      <form onSubmit={submit} className="mb-4 flex flex-col gap-3 px-4">
        <div className="relative mt-2 mb-4 flex flex-col items-center justify-center">
          ...
          <span className="z-10 -mt-2 bg-[#42474B] px-4 font-bold text-white">
            <s>1 ${saleToken[chainId].symbol} = $0.50</s> | 1{" "}
            {saleToken[chainId].symbol} ={" "}
            <span className="text-[#FFD700]"> $0.39</span>
          </span>
        </div>
              ...
              {isConnected ? (
                <>
                  <p className="col-span-2 border-y py-4 text-center text-sm font-medium uppercase text-white">
                    YOUR STAKED AMOUNT {lockedToken} $
                    {saleToken[chainId].symbol} Locked{" "}
                  </p>
                  <button
                    className="relative flex w-full items-center justify-center gap-2 rounded-lg bg-[#FFD700] py-3 px-6 text-lg font-semibold text-black transition-opacity duration-200 hover:opacity-75 disabled:cursor-not-allowed disabled:from-gray-400 disabled:opacity-80 lg:text-xl"
                ...
                <button
                  className="relative flex w-full items-center justify-center gap-2 rounded-lg bg-[#39FF14] py-3 px-6 text-lg font-semibold text-black transition-opacity duration-200 hover:opacity-75 disabled:cursor-not-allowed disabled:opacity-80 lg:text-xl"
                  disabled={loading}
                  type="button"
                  onClick={() => open()}
                >
